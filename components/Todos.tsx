...
// Functions
import { fetchParticipantNotionPage, fetchParticipantTeamNotionPage, peoplesChoiceVoteFound, submissionFound } from '@/functions/notion'
    ...
    <ul className={styles.todos}>
      ...
      }
      {
        projectSubmissionOpen && participant && team && !hasSubmitted &&
            <li className='fade'><Button text='Submit your project' type='link' destination={`/submit?participant_email=${user.email}&teamname=${teamName}`} /></li>
      }
      {
      ...
      }
      {
        peoplesChoiceVoteOpen && participant && team && !hasVoted &&
            <li className='fade'><Button text='Vote for People&apos;s Choice' type='link' destination={`/vote?participant_email=${user.email}&teamname=${teamName}`} /></li>
      }
      {
