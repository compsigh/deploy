    ...
    <main className={styles.main}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles["version-status"]}>
          ...
          <p>DEPLOY Platform v2.3.1 • <Link href="https://github.com/compsigh/deploy">Source Code</Link> • <Link href="https://compsigh.club/docs/code-of-conduct">compsigh Code of Conduct</Link></p>
        </div>
      </footer>
    </main>
  )
